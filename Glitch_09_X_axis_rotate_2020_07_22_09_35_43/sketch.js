...
function draw() {
  ...
  if (((h >= 1) && (h<3)) || ((h <= -1) && (h > -3))) {
    ...
    var w = 100; //displayWidth/0.0625;
    var g = 100;//displayWidth/0.0625;
    ...
    var w = 35; //displayWidth/0.0625;
    var g = 35;//displayWidth/0.0625;
    ...
    var w = 25; //displayWidth/0.0625;
    var g = 25;//displayWidth/0.0625;
